...
const deletePics = document.querySelector(".recent-header button")
  ...
  for (let [index, day] of days.entries()) {
    ...
    cardsHTML += `
      ...
      <div class="card-header">
        ...
        <div class="time">${hours>12 ? hours-12 : hours}:${minutes} ${hours > 11 ? "pm" : "am"}</div>
      </div>
      <div class="card-body">
...
deletePics.addEventListener("click", function(){
